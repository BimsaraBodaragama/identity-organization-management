...
public class SQLConstants {
    ...
    public static final String CREATE_ORGANIZATION_USER_ASSOCIATION_EXTENDED = "INSERT INTO UM_ORG_USER_ASSOCIATION(" +
            "UM_USER_ID, UM_ORG_ID, UM_ASSOCIATED_USER_ID, UM_ASSOCIATED_ORG_ID, UM_ASSOCIATION_INITIATED_ORG_ID, UM_ASSOCIATION_TYPE) " +
            "VALUES(?, ?, ?, ?, ?, ?)";
    ...
    public static final String GET_ORGANIZATION_USER_ASSOCIATIONS_FOR_SHARED_USER_BY_USER_ID =
            "SELECT UM_USER_ID, UM_ASSOCIATED_USER_ID, UM_ASSOCIATED_ORG_ID FROM UM_ORG_USER_ASSOCIATION WHERE UM_USER_ID = ?";
