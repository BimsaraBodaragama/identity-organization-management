...
public class UserShareMgtClientException extends UserShareMgtException {
    ...
    public UserShareMgtClientException(String message, String errorCode, String description) {

        super(message, errorCode, description);
    }

    public UserShareMgtClientException(String errorCode, String description) {

        super(errorCode, description);
    }

    public UserShareMgtClientException(Throwable cause, String errorCode, String description) {

        super(cause, errorCode, description);
    }

    public UserShareMgtClientException(String message, Throwable cause, String errorCode, String description) {

        super(message, cause, errorCode, description);
    }

    public UserShareMgtClientException(String message, Throwable cause, boolean enableSuppression,
