 ...
 */
public class SelectiveUserShareDO extends BaseUserShareDO<UserCriteriaType> {
    ...
    public void setOrganizations(List<SelectiveUserShareOrgDetailsDO> organizations) {
